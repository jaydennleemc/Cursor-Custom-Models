...
const en: Dict = {
  ...
  baseUrlInvalid: "Base URL must be a valid http(s) URL, e.g. https://api.example.com/v1",
  ctxEnv: "Environment",
  ...
  "tip.maxTokens": "max_tokens sent to the upstream API per request. Lower it if your provider rejects large output limits.",
  "tip.agentMaxToolRounds": "How many tool-execution rounds one Agent/Chat turn may run before the model must answer with text. Prevents runaway tool loops.",
...
const zhCN: Dict = {
  ...
  agentMaxToolRounds: "最大工具回合数",
  baseUrlInvalid: "Base URL 必须是有效的 http(s) 地址，例如 https://api.example.com/v1",
  ctxEnv: "环境信息",
  ctxRules: "项目规则",
  ctxRepo: "仓库信息",
  ctxLayout: "目录树",
  ...
  "tip.maxTokens": "每次请求发给上游 API 的 max_tokens。上游拒绝大输出上限时调小。",
  "tip.agentMaxToolRounds": "一轮 Agent/Chat 最多执行多少次工具，之后必须用文本作答。防止工具死循环。",
...
const zhTW: Dict = {
  ...
  agentMaxToolRounds: "最大工具回合數",
  baseUrlInvalid: "Base URL 必須是有效的 http(s) 網址，例如 https://api.example.com/v1",
  ctxEnv: "環境資訊",
  ctxRules: "專案規則",
  ctxRepo: "儲存庫資訊",
  ctxLayout: "目錄樹",
  ...
  "tip.maxTokens": "每次請求送給上游 API 的 max_tokens。上游拒絕大輸出上限時調小。",
  "tip.agentMaxToolRounds": "一輪 Agent/Chat 最多執行多少次工具，之後必須以文字作答。防止工具死迴圈。",
