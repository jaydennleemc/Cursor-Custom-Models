...
const en: Dict = {
  ...
  agentPrompt: "Agent System Prompt (Optional; Empty = Passthrough)",
  ...
  sampling: "Sampling & Debug",
  temperature: "Temperature",
  maxTokens: "Max Tokens",
  debugDump: "Debug Dump",
  reasoningAsText: "Send Reasoning As Visible Text",
  ...
  "tip.agentPrompt": "Extra system text prepended to Agent requests. Leave empty to pass Cursor’s prompt through unchanged.",
  "tip.toolTimeout": "How long to wait for one tool call before giving up, in milliseconds.",
  "tip.maxRounds": "Maximum tool-call rounds in one Agent turn. Higher means more steps and more tokens.",
  ...
  "tip.sampling": "Optional generation parameters sent to the OpenAI-compatible API. Empty fields are omitted.",
  "tip.temperature": "Sampling temperature. Leave empty to use the provider default.",
  "tip.maxTokens": "Maximum output tokens. Leave empty to use the provider default.",
...
const zhCN: Dict = {
  ...
  agentPrompt: "Agent System Prompt（可选，默认纯透传）",
  toolTimeout: "工具超时 (ms)",
  maxRounds: "最大轮数",
  ctxEnv: "环境信息",
  ctxRules: "项目规则",
  ...
  "tip.agentPrompt": "追加到 Agent 请求前面的系统提示。留空则原样透传 Cursor 的提示词。",
  "tip.toolTimeout": "单次工具调用的最长等待时间，单位毫秒。",
  "tip.maxRounds": "一轮 Agent 里最多跑几轮工具。越大步骤越多、也越耗 token。",
  ...
  "tip.sampling": "发给 OpenAI 兼容接口的可选生成参数。留空表示不传，用供应商默认值。",
  "tip.temperature": "采样温度。留空则用供应商默认值。",
  "tip.maxTokens": "最大输出 token 数。留空则用供应商默认值。",
...
const zhTW: Dict = {
  ...
  agentPrompt: "Agent System Prompt（選填，預設純透傳）",
  toolTimeout: "工具逾時 (ms)",
  maxRounds: "最大輪數",
  ctxEnv: "環境資訊",
  ctxRules: "專案規則",
  ...
  "tip.agentPrompt": "加到 Agent 請求前面的系統提示。留空則原樣透傳 Cursor 的提示詞。",
  "tip.toolTimeout": "單次工具呼叫的最長等待時間，單位毫秒。",
  "tip.maxRounds": "一輪 Agent 最多跑幾輪工具。越大步驟越多、也越耗 token。",
  ...
  "tip.intercept.agent": "Agent / Composer 的 Run 通道。",
  "tip.sampling": "發給 OpenAI 相容介面的可選生成參數。留空表示不傳，用供應商預設值。",
  "tip.temperature": "取樣溫度。留空則用供應商預設值。",
  "tip.maxTokens": "最大輸出 token 數。留空則用供應商預設值。",
